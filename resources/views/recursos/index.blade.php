...
@section('content_header')
    <h3 class="text-center"><i>Fondos Monetarios</i></h3>
@stop
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card">
                    ...
                    <table id="recurso" class="table table-striped table-bordered text-center shadow-lg mt-4 display responsive nowrap" style="width:100%">
                            <thead style="background-color:purple">
                                <th style="display: none;"><i>#</i></th>
                                ...
                                <th><i style="color:blanchedalmond; font-size: 12px;">Gestion</i></th>
                                <th><i style="color:blanchedalmond; font-size: 12px;">Monto</i></th>
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><i style="color:blanchedalmond; font-size: 12px;">{{ $recurso->nombre }}</i></td>
                                    <td><i style="color:blanchedalmond; font-size: 12px;">{{ $recurso->descripcion }}</i></td>
                                    <td><i style="color:blanchedalmond; font-size: 12px;">{{ $recurso->gestion }}</i></td>
                                    <td><i style="color:blanchedalmond; font-size: 12px;">{{ $recurso->monto }}</i></td>
                                    <td>
                                        @if ($recurso->estado == 'activo')
                                            <button type="button" class="btn btn-warning"><i style="color:blanchedalmond; font-size: 12px;">Activo</i></button>
                                        @endif
                                        @if ($recurso->estado == 'inactivo')
                                            <button type="button" class="btn btn-danger"><i style="color:blanchedalmond; font-size: 12px;">Inactivo</i></button>
                                        @endif
                                    </td>
                                    <td>
                                        @can('editar-recurso')
                                                <button type="button" class="btn btn-success" data-bs-toggle="modal" data-bs-target="#exampleModal{{ $recurso->id }}">
