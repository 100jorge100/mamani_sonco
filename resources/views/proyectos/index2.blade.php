                    ...
                    success: function (response) {
                        ...
                        $.each(response.proyectos, function (key, item) {
                            $('tbody').append('<tr>\
                                ...
                                <td>' + item.estado + '</td>\
                                <td>@can('editar-proyecto')<button type="button" value="' + item.id + '" class="btn btn-primary editbtn btn-sm"><i class="fas fa-pen"></i></button>@endcan @can('eliminar-proyecto')<button type="button" value="' + item.id + '" class="btn btn-danger deletebtn btn-sm"><i class="fas fa-trash"></i></button>@endcan</td>\
                            \</tr>');
                        });
                    }
                });
                 ...
                 $.ajax({
                     ...
                     success: function (response) {
                         if (response.status == 404) {
                             ...
                             $('#id_comunidad').val(response.proyecto.id_comunidad);
                             $('#id_recurso').val(response.proyecto.id_recurso);
                             $('#id_empresa').val(response.proyecto.id_empresa);
                             $('#id_categoria').val(response.proyecto.id_categoria);
                             $('#fecha_inicio').val(response.proyecto.fecha_inicio);
                             $('#fecha_final').val(response.proyecto.fecha_final);
